...
- **Karanlık mod:** yalnızca cihaz/tarayıcı karanlık istediğinde (telefonun karanlık modu ya da "zorla karartma") krem ve beyaz bölümler ile program kitapçığı antrasit/bronz tonlara döner; diğer durumlarda sayfa açık bölümleriyle görünür.
