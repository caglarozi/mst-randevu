/* MST Yazar Kariyer Akademisi — aşama seçimi ve Yazar Kariyer Analizi formu.
 * - "Hangi aşamadasınız?" kartı seçilince formdaki aşama işaretlenir, önerilen program vurgulanır
  ...
  function basla() {
    ...
    document.querySelectorAll('[data-akd-asama]').forEach(function (d) {
      d.addEventListener('click', function () {
        var a = d.getAttribute('data-akd-asama'), r = form.querySelector('[name="asama"][value="' + a + '"]');
        if (r) { r.checked = true; oneriGoster(a); }
        adimaGit(0);
